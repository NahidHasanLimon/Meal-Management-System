      ...
      <div class="modal-body">
        <form class="form-horizontal col-sm-12" id="contactForm" method="post" action="" >
          ...
          <div class="form-group"><label>subject</label>
            <textarea  name="subject" id="subject"class="form-control" placeholder="Your subject here.." data-placement="top" data-trigger="manual" required></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="contact_no"id="contact_no" class="form-control phone" placeholder ="Must be a valid phone number (016-****-***)" type="text" required>
          </div>
          <div class="form-group">
