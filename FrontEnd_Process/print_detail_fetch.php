    ...
    $today = date("d/m/Y"); 
      ...
      echo "No Data Available";
        ...
        //Satrt Meal Details
          ...
          $user_meal_cost=$result["expense"];
          $user_meal_remaining_amount=$result["remaining_meal_amount"];
          //End Meal Details
          ...
          $per_user_rent = (($rent_total)/4);
          $per_user_utility = (($utility_total)/4);
          $per_user_extra = (($extra_total)/4);
